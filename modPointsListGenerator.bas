...
' ============================================================================
' SCADA POINTS LIST GENERATOR  —  Rev 11
' ============================================================================
'
' CHANGES FROM Rev 10:
'   BUG FIXES
...
Private Sub RunCompareEngine(ByVal runMode As Long)
    ...
    For r = 1 To existRows
        ...
        For c = 1 To numPtsCols
            ...
            ' Always ignore AESO columns - these are manually maintained in
            ' the Points List and are never generated from source tables.
