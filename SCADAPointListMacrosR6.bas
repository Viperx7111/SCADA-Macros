...
NextDataRow:
    ...
    totalDevices = totalComplete + totalIncomplete
    ...
    wsReport.Cells(writeRow, 4).Value = "Total"
    wsReport.Cells(writeRow, 5).Value = "% Complete"
    With wsReport.Range(wsReport.Cells(writeRow, 1), wsReport.Cells(writeRow, 5))
        .Font.Bold = True
        .Interior.Color = RGB(68, 114, 196)
        .Font.Color = RGB(255, 255, 255)
    End With
    ...
    For Each areaKey In areaKeys
        ...
        areaTotal       = completeCount + incompleteCount
        ...
        wsReport.Cells(writeRow, 4).Value = areaTotal
        wsReport.Cells(writeRow, 5).Value = pctComplete
        wsReport.Cells(writeRow, 5).NumberFormat = "0%"
    ...
    wsReport.Cells(writeRow, 4).Value = totalDevices
    wsReport.Cells(writeRow, 5).Value = pctComplete
    wsReport.Cells(writeRow, 5).NumberFormat = "0%"
    With wsReport.Range(wsReport.Cells(writeRow, 1), wsReport.Cells(writeRow, 5))
        .Font.Bold = True
